...
int trn_agent_bpf_maps_init(struct agent_user_metadata_t *md)
{
	...
	md->eg_vsip_enforce_map = bpf_object__find_map_by_name(md->obj, "eg_vsip_enforce_map");
	md->eg_vsip_prim_map = bpf_object__find_map_by_name(md->obj, "eg_vsip_prim_map");
	md->eg_vsip_ppo_map = bpf_object__find_map_by_name(md->obj, "eg_vsip_ppo_map");
	md->eg_vsip_supp_map = bpf_object__find_map_by_name(md->obj, "eg_vsip_supp_map");
	md->eg_vsip_except_map = bpf_object__find_map_by_name(md->obj, "eg_vsip_except_map");
	md->ing_vsip_enforce_map = bpf_object__find_map_by_name(md->obj, "ing_vsip_enforce_map");
	md->ing_vsip_prim_map = bpf_object__find_map_by_name(md->obj, "ing_vsip_prim_map");
	md->ing_vsip_ppo_map = bpf_object__find_map_by_name(md->obj, "ing_vsip_ppo_map");
	md->ing_vsip_supp_map = bpf_object__find_map_by_name(md->obj, "ing_vsip_supp_map");
	md->ing_vsip_except_map = bpf_object__find_map_by_name(md->obj, "ing_vsip_except_map");
	md->conn_track_cache = bpf_object__find_map_by_name(md->obj, "conn_track_cache");
